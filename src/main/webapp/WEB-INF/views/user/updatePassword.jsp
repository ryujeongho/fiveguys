        ...
        <form name="userPasswordUpdateFrm" class="space-y-6" method="POST">
            ...
            <div>
                <div class="flex items-center justify-between">
                    <label for="newPassword" class="block text-sm font-medium leading-6 text-gray-900">새 비밀번호</label>
                </div>
                <div class="mt-2">
...
<script src="${pageContext.request.contextPath}/js/user/updatePassword.js"></script>
